...
insert into lei_leilao (lei_id,lei_data_hora, lei_data_visitacao, lei_descricao, lei_status)
    values (1, '2023-12-29T09:27:39', '2023-11-27', 'Este lei é um teste', 'EM_ABERTO');
insert into lei_leilao (lei_id,lei_data_hora, lei_data_visitacao, lei_descricao, lei_status)
    values (2, '2024-01-25T09:00:00', '2023-12-01', 'Este lei é um teste também', 'EM_ABERTO');
